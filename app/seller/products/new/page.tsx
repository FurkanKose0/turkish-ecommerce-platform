...
import { FiArrowLeft, FiSave, FiPackage, FiImage, FiAlignLeft, FiTag, FiHash, FiUpload } from 'react-icons/fi'
...
export default function NewProductPage() {
    ...
    useEffect(() => {
        // Giyim kategorisi kontrolü (4, 5, 6 - önceki sorgudan öğrendik)
        const clothingCategoryIds = [4, 5, 6]
        if (clothingCategoryIds.includes(parseInt(categoryId))) {
            setShowSizes(true)
        } else {
            setShowSizes(false)
        }
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            // Seçili bedenleri string olarak (S,M,L) formatında hazırla
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1">
                    <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6 shadow-sm">
                        <h1 className="text-xl font-bold text-gray-900 mb-6">Yeni Ürün Ekle</h1>
                        ...
                        <form onSubmit={handleSave} className="space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="block w-full bg-white border border-gray-300 rounded-lg text-gray-900 py-2.5 px-3 focus:border-green-500 focus:ring-1 focus:ring-green-500 outline-none appearance-none"
                                    required
                                >
                                ...
                                <div>
                                    ...
                                    <div className="relative mb-4">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                if (showSizes) return;
                                                const val = e.target.value.replace(/^0+(?!$)/, ''); // Sadece başta kalan sıfır varsa 0'ı korur, 01 -> 1 yapar
                                                setStock(val);
                                            }}
                                            disabled={showSizes}
                            ...
                            {/* SKU */}
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Ürün Kodu (SKU)</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <div className="absolute top-3 left-3 flex items-start pointer-events-none">
                                        <FiAlignLeft className="text-gray-400 mt-1" />
                                    </div>
                                    <textarea
                                        value={description}
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-6 shadow-sm">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="text-gray-900 text-right font-medium">{productName || '-'}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500">Fiyat:</span>
                                <span className="text-green-600 text-right font-bold">{price ? parseFloat(price).toLocaleString('tr-TR') : '0'} ₺</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500">Stok:</span>
                                <span className="text-gray-900 text-right">{stock || '0'} adet</span>
                            </div>
                        </div>
                    </div>
                </div>
